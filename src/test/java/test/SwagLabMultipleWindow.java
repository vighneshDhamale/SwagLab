...
import pom.SwagLabLoginPageNew1;
...
public class SwagLabMultipleWindow {
	WebDriver driver;
	...
	@Test(priority=4)
	public void validateSwagLabLoginPageNew1() throws Exception{
		test=extent.createTest("SwagLabMultipleWindow");
		SwagLabLoginPageNew1 swagLabLoginPagenew = new  SwagLabLoginPageNew1(driver);
		
		swagLabLoginPagenew.enterusername(Parametrization.getExcelData(0, 1, "Sheet1"));
		swagLabLoginPagenew.enterpassword(Parametrization.getExcelData(2, 1, "Sheet1"));
		swagLabLoginPagenew.clickOnLogin();
		swagLabLoginPagenew.clickonTwitter();
		...
		Thread.sleep(50000);
		swagLabLoginPagenew.clickonfacebook();
		driver.switchTo().window(parentwindow);
		Thread.sleep(8000);
		swagLabLoginPagenew.clickonlinkdin();
	}
